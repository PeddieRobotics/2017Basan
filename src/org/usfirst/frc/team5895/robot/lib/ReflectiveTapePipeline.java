...
public class ReflectiveTapePipeline implements VisionPipeline {
	...
	@Override	public void process(Mat source0) {
		...
		double[] rgbThresholdRed = {0.0, 107.27272727272728};
		double[] rgbThresholdGreen = {127.25988700564974, 255.0};
		double[] rgbThresholdBlue = {124.85875706214689, 255.0};
	...
	public double getCenter(){
		...
		mu.add(0, Imgproc.moments(findContoursOutput.get(0)));
		double m10 = mu.get(0).m10;
		double m00 = mu.get(0).m00;
		double m01 = mu.get(0).m01;
		centerX = m10/m00;
		centerY = m01/m00;
		return centerX;
	  }
